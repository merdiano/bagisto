            ...
            <div class="sale-container">
                ...
                <div class="sale-section">
                    <div class="section-content">
                        ...
                        <div class="control-group" :class="[errors.has('shipment[carrier_title]') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required'" class="control" id="shipment[carrier_title]" name="shipment[carrier_title]" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.sales.shipments.carrier-title') }}&quot;"/>
                        ...
                        <div class="control-group" :class="[errors.has('shipment[track_number]') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required'" class="control" id="shipment[track_number]" name="shipment[track_number]" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.sales.shipments.tracking-number') }}&quot;"/>
    ...
    <script type="text/x-template" id="order-item-list-template">
        ...
        <div>            
            <div class="control-group" :class="[errors.has('shipment[source]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" class="control" name="shipment[source]" id="shipment[source]" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.sales.shipments.source') }}&quot;" v-model="source">
